    ...
    <>
      ...
      <div className='bg-[#1c2022] py-4'>
        <div className='flex h-full text-white w-full justify-center'>
          <div className='w-[80%]'>
            <p className='text-2xl font-bold py-2 text-center'>Privacy Policy di Gral</p>
            <p>

              Gral è un chatbot creato utilizzando le chiavi API di OpenAI. La nostra politica sulla privacy è stata creata per proteggere le informazioni personali dei nostri utenti. La presente privacy policy descrive come vengono raccolti, utilizzati e divulgati i dati personali degli utenti del nostro servizio.
              <br />
              Raccolta di informazioni personali
              Gral richiede ai suoi utenti di fornire informazioni personali come nome e cognome, indirizzo e-mail e password durante la fase di registrazione. Queste informazioni sono necessarie per fornire un servizio personalizzato e per garantire l'accesso sicuro al nostro servizio.
              <br />
              ...
              Gral adotta misure di sicurezza tecniche e organizzative per proteggere le informazioni personali degli utenti da accessi non autorizzati, modifiche o divulgazioni.
              <br />
              Modifiche alla privacy policy
              Gral si riserva il diritto di modificare la presente privacy policy in qualsiasi momento. Tutte le modifiche saranno comunicate agli utenti tramite e-mail o attraverso il nostro servizio.
              <br />
              Contatti
